...
<main >
    <div id="nu">
                <form name="nu" method="post" action="url" role="form" class="form-horizontal">
                    ...
                    <h1><img src="assets/imagenes/documento.png" class="col-12 col-md-6 col-lg-7"> CREAR ALBUM </h1>
                    
                    <div class="form-group row">
                    <label for="idu" class="col-lg-5">Ingrese el nombre</label>
                    <input type="text" name="idu" id="idu" class="col-lg-7">
                    </div>

                    <div class="form-group row">
                        <label for="FECHA " class="col-lg-5">Fecha de creación</label>
