...
<main >
    <div id="nu">
                <form name="nu" method="post" action="url" role="form" class="form-horizontal">
                    ...
                    <h1><img src="assets/imagenes/documento.png" class="col-12 col-md-6 col-lg-7"> EDITAR CANCIÓN </h1>
                    
                    <div class="form-group row">
                    <label for="idu" class="col-lg-5">Nombre de la canción</label>
                    ...
                    <div class="form-group row">
                        <label for="documento" class="col-lg-5">Estado</label>
                        <input type="text" name="documento" id="documento" class="col-lg-7">
                    </div>
