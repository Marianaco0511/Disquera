...
<main >
    <div id="nu">
                <form name="nu" method="post" action="url" role="form" class="form-horizontal">
                    ...
                    <h1><img src="assets/imagenes/documento.png" class="col-12 col-md-6 col-lg-7"> REGISTRAR ARTISTA </h1>
                    ...
                    <div class="form-group row">
                        <label for="FECHA " class="col-lg-5">Años activ@</label>
                    ...
                    <div class="form-group row">
                        <label for="FECHA " class="col-lg-5">Fecha de nacimiento</label>
                         <input type="date" name="FECHA" class="col-lg-7">
                    </div>
