...
<main >
    <div id="nu">
                <form name="nu" method="post" action="url" role="form" class="form-horizontal">
                    ...
                    <h1><img src="assets/imagenes/documento.png" class="col-12 col-md-6 col-lg-7"> ELIMINAR ALBUM </h1>
                    ...
                    <div class="form-group row">
                    <input type="submit" name="beliminar" value="Eliminar" class="botwo" class="col-lg-7">
                    </div>
                </form>
