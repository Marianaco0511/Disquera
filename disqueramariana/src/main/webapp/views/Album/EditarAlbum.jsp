...
<main >
    <div id="nu">
                <form name="nu" method="post" action="url" role="form" class="form-horizontal">
                    ...
                    <h1><img src="assets/imagenes/documento.png" class="col-12 col-md-6 col-lg-7">  EDITAR ALBUM </h1>
                    
                    <div class="form-group row">
                    <label for="idu" class="col-lg-5">Editar nombre</label>
                    <input type="text" name="idu" id="idu" class="col-lg-7">
                    </div>

                    <div class="form-group row">
                        <label for="documento" class="col-lg-5">Nombre de los cantantes</label>
                        <input type="text" name="documento" id="documento" class="col-lg-7">
                    </div>

                    <div class="form-group row">
                        <label for="documento" class="col-lg-5">Nombre del cantante</label>
                        <input type="text" name="documento" id="documento" class="col-lg-7">
                    </div>

                    <div class="form-group row">
                        <label for="FECHA " class="col-lg-5">Fecha de publicación</label>
                         <input type="date" name="FECHA" class="col-lg-7">
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="documento" class="col-lg-5">Fecha ultima modificación</label>
                        <input type="text" name="documento" id="documento" class="col-lg-7">
                    </div>
